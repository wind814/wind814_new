...
<head>
    ...
    <title>Wind814 Deily Fitness</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>Wind814</strong> Daily fitness</h1>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="" id="loginForm" name="loginForm" method="post" class="login-form">
                            ...
                            <button type="button" onclick="Login.doLogin()" class="btn">Sign in!</button>
                        </form>
...
<script type="text/javascript" charset="UTF-8" src="/javascripts/login/login.js"></script>

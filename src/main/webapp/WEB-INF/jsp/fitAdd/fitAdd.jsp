            ...
            <div class="tab-pane active" id="tab_0">
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-5" style="padding-left: 10%">
                        ...
                        <!-- 动作选择-->
                        <div class="form-group" >
                            <label class="col-sm-3 control-label">动作选择:</label>
                            <div class="col-sm-5">
                                <select  class="form-control input_width" onchange="Fitadd.doFitActionTypeDetailList(this)" id="actionType" >
                        ...
                        <!-- 体重-->
                        <div class="form-group">
                            <label class="col-sm-3 control-label">体重自测:</label>
                            <div class="col-sm-5" class="checker">
                                <input type="text" id="weight" name="weight" value="" class="input_width"/>
                            </div>
                        </div>
                        <br />
                        <!-- 心得-->
                        <div class="form-group">
                            <label class="col-sm-3 control-label">心得:</label>

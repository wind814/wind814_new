        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat purple">
                    ...
                    <div class="details">
                        ...
                        <div class="desc">饮食记录</div>
                    </div>
                    <a class="more" href="/fitDietRecords/toFitDietRecords">
                        View more <i class="m-icon-swapright m-icon-white"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat yellow">
                    <div class="visual">
                        <i class="fa fga-bar-chart-o"></i>
                    </div>
                    <div class="details">
                        <div class="number">12,5M$</div>
                        <div class="desc">体重分析折线图</div>
                    </div>
                    <a class="more" href="/fitSearch/toWeightAnalysis">
                        View more <i class="m-icon-swapright m-icon-white"></i>
                    </a>
                </div>
            </div>

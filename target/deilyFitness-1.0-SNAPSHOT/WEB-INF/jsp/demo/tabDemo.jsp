...
<div class="page-container" >
    ...
    <div class="page-content">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class=""><a href="#tab_5" data-toggle="tab">Bordered</a></li>
            <li class=""><a href="#tab_6" data-toggle="tab">Row Stripped</a></li>
            <li class=""><a href="#tab_7" data-toggle="tab">Label Stripped</a></li>
        </ul>
